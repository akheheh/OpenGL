...
int main()
{
    ...
    // stbi_load(image source, width, height, number of color channels in the image source, number of channels you want to use: 0 is same as the previous argument)
